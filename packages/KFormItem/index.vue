...
<template>
  <a-form-item
    ...
    "
    :label="record.label"
    :label-col2="formConfig.layout === 'horizontal' ? formConfig.labelCol : {}"
    :label-col="{span: 24}"
    :wrapper-col="{span: 24}"
    :wrapper-col2="
  ...
  >
    ...
    ><a-icon type="scan" slot='suffix' v-show='record.options.scan' /></a-input>
    <!-- 多行文本 -->
    <a-textarea
      :style="`width:${record.options.width}`"
    ...
    />
    <!-- 单选框 -->
    <a-radio-group class='radio-group'
  ...
  <!-- button按钮 , offset: formConfig.labelCol.span-->
  <a-form-item
...
/deep/ .radio-group .ant-radio-wrapper,
...
/deep/ span.ant-radio + *, /deep/ .ant-checkbox + span{
