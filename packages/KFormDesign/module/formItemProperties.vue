    ...
    <div class="properties-body">
      ...
      <a-form v-show="selectItem.key !== ''">
        ...
        >
          ...
          />
          <kCheckbox
            v-if="typeof options.scan !== 'undefined'"
            v-model="options.scan"
            label="支持扫码录入"
          />
          <kCheckbox
            v-if="typeof options.currentDate !== 'undefined'"
            v-model="options.currentDate"
            label="默认当前日期"
          />
          <kCheckbox
            v-if="typeof options.currentTime !== 'undefined'"
            v-model="options.currentTime"
            label="自动获取当前时间"
          />
          <!-- <kCheckbox
